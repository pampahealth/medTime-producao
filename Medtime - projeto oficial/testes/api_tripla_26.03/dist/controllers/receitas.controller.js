...
function toIsoDate(ano, mes, dia) {
...
function parseDataFiltro(input) {
...
class ReceitasController {
    ...
    async porData(req, res) {
        ...
        if (!filtroInicio) {
            res.status(400).json({
                error: "data_receita deve estar em um dos formatos: DD, DD/MM, DD/MM/YYYY, YYYY/DD/MM, DD.MM, DD.MM.YYYY, YYYY.DD.MM, DD MM, DD MM YYYY ou YYYY DD MM"
            });
            return;
        }
        ...
        if (!rawFim) {
            ...
            if (!filtroFim) {
                res.status(400).json({
                    error: "data_receita_fim deve estar em um dos formatos: DD, DD/MM, DD/MM/YYYY, YYYY/DD/MM, DD.MM, DD.MM.YYYY, YYYY.DD.MM, DD MM, DD MM YYYY ou YYYY DD MM"
                });
                return;
            }
